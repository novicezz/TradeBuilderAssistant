...
# Convert to Common Calculation
    setupTable["entry"] = setupTable["dzone"]["proximal"]
...
# Activation rule calculation
    ...
    activationPrice = rounddown(activationPrice, HUNDREDTH)
...
# Position size calculator
    ...
    positionCost = positionSize * setupTable["entry"]
...
# Print position
    ...
    report += f"Activation price:   {activationPrice}\n"
...
def short_position(setupTable: dict):
    setupTable["entry"] = setupTable["szone"]["proximal"]
    szSize = setupTable["szone"]["distal"] - setupTable["szone"]["proximal"]
    pass
    # stopLoss = setupTable["szone"]["distal"] + (setupTable["atr"] * stopLossBuffer) for Short
